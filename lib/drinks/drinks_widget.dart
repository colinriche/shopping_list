...
class _DrinksWidgetState extends State<DrinksWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DrinksModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<ShoppingRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ShoppingRow> drinksShoppingRowList = snapshot.data!;
        return Title(
            title: 'Drinks',
            color: FlutterFlowTheme.of(context).primaryColor,
            child: Scaffold(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Builder(
                              builder: (context) {
                                final drinks = drinksShoppingRowList.toList();
                                return SingleChildScrollView(
                                  child: Column(
                                    mainAxisSize: MainAxisSize.max,
                                    children: List.generate(drinks.length,
                                        (drinksIndex) {
                                      final drinksItem = drinks[drinksIndex];
                                      return Container(
                                        width: 100.0,
                                        height: 100.0,
